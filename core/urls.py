...
from .views import GameSystemViewSet, CharacterTraitViewSet, EquipmentTemplateViewSet, FeatureViewSet

# Используем DefaultRouter для корневых эндпоинтов
router = routers.DefaultRouter()
router.register('systems', GameSystemViewSet, basename='systems')
router.register('equipment-templates', EquipmentTemplateViewSet, basename='equipment-templates')
